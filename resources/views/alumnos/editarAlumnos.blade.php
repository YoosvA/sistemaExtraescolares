            ...
            <div class="col">
                <form action="{{route('update', $items->id)}}" method="post">
                    ...
                    @method('PUT')
                        ...
                        <input type="text" name="apellidoPaterno" id="apellidoPaterno" class="form-control" value="{{$items->apellidoPaterno}}" required>
                        <label for="apellidoMaterno">Apellido Materno</label>
                        <input type="text" name="apellidoMaterno" id="apellidoMaterno" class="form-control" value="{{$items->apellidoMaterno}}" required>
                        ...
                        <input type="text" name="escuelaProcedencia" id="escuelaProcedencia" class="form-control" value="{{$items->escuelaProcedencia}}" required>
                        <label for="fechafechaIngresoNac">Fecha de Ingreso al Tecnologico</label>
                        <input type="date" name="fechaIngreso" id="fechaIngreso" class="form-control" value="{{$items->fechaIngreso}}" required>

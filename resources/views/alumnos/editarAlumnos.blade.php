                            ...
                            <form action="{{ route('update', $items->id) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="apellidoPaterno" id="apellidoPaterno" class="form-control rounded-pill text-center"
                                            value="{{ $items->apellidoPaterno }}" required>
                                        <h4 class="mt-3">Apellido Materno</h4>
                                        <input type="text" name="apellidoMaterno" id="apellidoMaterno" class="form-control rounded-pill text-center"
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="escuelaProcedencia" id="escuelaProcedencia" class="form-control rounded-pill text-center"
                                            value="{{ $items->escuelaProcedencia }}" required>
                                        <h4 class="mt-3">Fecha de Ingreso al Tecnologico</h4>
                                        <input type="date" name="fechaIngreso" id="fechaIngreso" class="form-control rounded-pill text-center"

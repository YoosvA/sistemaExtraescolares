                                        ...
                                        <div class="row row-cols-1 row-cols-md-3 g-4">
                                            <div class="col">
                                                <div class="card border-0 colorTransparente">
                                                    <div class="card-body">
                                                        <!---->
                                                        <h4 class="ms-3"><i class="fas fa-user"></i> Nombre del Alumno
                                                        </h4>
                                                        <input type="text" name="nombre" id="nombre"
                                                            class="form-control rounded-pill text-center shadow-sm  bg-body mt-3 mb-3"
                                                            value="{{ $items->nombre }}" required>
                                                        <!---->
                                                        <h4 class="ms-3 mt-2 mb-2"><i class="fas fa-sort-amount-down"></i>
                                                            Numero de Control</h4>
                                                        <input type="text" name="noControl" id="noControl"
                                                            class="form-control rounded-pill text-center shadow-sm  bg-body mt-3 mb-3"
                                                            value="{{ $items->noControl }}" required>
                                                        <!---->
                                                        <h4 class="ms-3 mt-2 mb-2"><i class="fas fa-calendar-alt"></i> Fecha
                                                            de <br> Nacimiento</h4>
                                            ...
                                            <div class="col">
                                                <div class="card border-0 colorTransparente">
                                                    <div class="card-body">
                                                        ...
                                                        <!---->
                                                        <h4 class="ms-3 mt-2 mb-2"><i class="fas fa-phone"></i> Numero de
                                                            Celular</h4>
                                                        <input type="text" name="telefono" id="telefono"
                                                            class="form-control rounded-pill text-center shadow-sm  bg-body mt-3 mb-3"
                                                            value="{{ $items->telefono }}" required>
                                                        <!---->
                                                        <h4 class="ms-3 mt-2 mb-2"><i class="fas fa-balance-scale-left"></i>
                                                ...
                                                <div class="card border-0 colorTransparente">
                                                    <div class="card-body">
                                                        ...
                                                        <select name="carrera" id="carrera"
                                                            class="form-select rounded-pill text-center shadow-sm  bg-body mt-3 mb-3"
                                                            required>

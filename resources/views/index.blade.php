                        ...
                        <div class="ImagenEnchiladas img-fluid" id="DatosPersonalesDelAlumno">
                            <main class="main">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="text-center">
                                                    &nbsp;&nbsp;&nbsp;
                                                    <img src="{{ asset('img/LOGO_TECNM_BLANCO.png') }}"
                                                        class="tamañoDeLogoBlanco img-fluid" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <h3 class="text-center text-white">Sistema <br> ExtraEscolares</h3>
                                            </li>
                                            <li><a href="#DatosPersonalesDelAlumno">Datos Personales <br> Del Alumno</a>
                                            </li>
                                ...
                                <div class="content">
                                    ...
                                    <h4 class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Deserunt, id corporis.
                                        Eveniet praesentium assumenda laudantium deserunt omnis est maxime, rerum rem
                                        aliquid
                                                ...
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        <img src="{{ asset('img/Persona1.jpg') }}"
                                                            class="rounded-circle tamañoDeImgPersona img-fluid"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <h2 class="ms-5">Caracteristicas</h2>
                                    <h5 class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Temporibus quos sequi expedita quo odit
                                        inventore
                                        neque quisquam praesentium! Eveniet aut mollitia quo vel commodi delectus, natus
                                        autem ipsa recusandae
                                        voluptas!Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus quos
                                        sequi expedita quo
                                        odit
                                        inventore
                                        neque quisquam praesentium! Eveniet aut mollitia quo vel commodi delectus, natus
                                ...
                                <h2 class="ms-5">Caracteristicas</h2>
                                <h4 class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt,
                                    id
                                    corporis.
